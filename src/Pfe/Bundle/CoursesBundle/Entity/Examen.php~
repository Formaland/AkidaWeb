 ...
 * @ORM\Entity(repositoryClass="Pfe\Bundle\CoursesBundle\Entity\Repository\ExamenRepository")
 */
class Examen
{
    /**
     ...
     * @ORM\ManyToMany(targetEntity="Pfe\Bundle\CoursesBundle\Entity\Typeexamen", inversedBy="typeexamen",  cascade={"persist"})
     */
