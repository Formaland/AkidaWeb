...
use Pfe\Bundle\SessionBundle\Entity\Classroom;
use Pfe\Bundle\SessionBundle\Form\ClassroomType;
...
class ClassroomController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PfeSessionBundle:Classroom')->findAll();
     ...
     * @Method("POST")
     * @Template("PfeSessionBundle:Classroom:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PfeSessionBundle:Classroom')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PfeSessionBundle:Classroom:edit.html.twig")
     */
