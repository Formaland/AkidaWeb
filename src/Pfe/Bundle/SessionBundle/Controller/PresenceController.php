...
use Pfe\Bundle\SessionBundle\Entity\Presence;
use Pfe\Bundle\SessionBundle\Form\PresenceType;
...
class PresenceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PfeSessionBundle:Presence')->findAll();
     ...
     * @Method("POST")
     * @Template("PfeSessionBundle:Presence:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PfeSessionBundle:Presence')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PfeSessionBundle:Presence:edit.html.twig")
     */
